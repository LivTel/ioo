...
// $Header: /space/home/eng/cjm/cvs/ioo/java/ngat/o/ccd/CCDLibraryFormatException.java,v 1.2 2013-03-25 15:07:13 cjm Exp $
package ngat.o.ccd;
...
public class CCDLibraryFormatException extends IllegalArgumentException
{
	 ...
	 */
	public final static String RCSID = new String("$Id: CCDLibraryFormatException.java,v 1.2 2013-03-25 15:07:13 cjm Exp $");
	 ...
	 * @param fromClassName The name of the class the exception occured in.
	 * @param methodName The name of the method the exception occured in.
	 * @param illegalParameter The illegal integer that could not be parsed by the method.
	 */
	public CCDLibraryFormatException(String fromClassName,String methodName,int illegalParameter)
	{
		super("CCDLibraryFormatException:"+fromClassName+":"+methodName+":Illegal Value:"+
			illegalParameter);
	}
}
