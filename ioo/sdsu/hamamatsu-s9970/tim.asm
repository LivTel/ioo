...
CC	EQU	ARC22+ARC48+ARC50+SHUTTER_CC+SUBARRAY+BINNING
...
PARALLEL 		DC	PARALLEL_UP
PARALLEL_CLEAR 		DC	PARALLEL_CLEAR_UP
SERIAL_SKIP 		DC	SERIAL_SKIP_LEFT
FIRST_CLOCKS 		DC 	FIRST_CLOCKS_LEFT
CLOCK_LINE 		DC 	CLOCK_LINE_LEFT
SXMIT			DC 	$00F000
CHARGE_DUMP 		DC 	CHARGE_DUMP_LEFT
INTEGRATE_SIGNAL 	DC 	INTEGRATE_SIGNAL_LEFT
