;  This file is used to generate boot DSP code for the Gen III 250 MHz fiber 
;	optic timing board = ARC22 using a DSP56303 as its main processor.
...
2,1,0		Video Processor
			000	ARC41, CCD Rev. 3
			001	CCD Gen I
			010	ARC42, dual readout CCD
			011	ARC44, 4-readout IR coadder
			100	ARC45. dual readout CCD
			101	ARC46 = 8-channel IR
			110	ARC48 = 8 channel CCD
			111	ARC47 = 4-channel CCD
			
4,3		Timing Board
			00	ARC20, Rev. 4, Gen II
			01	Gen I
			10	ARC22, Gen III, 250 MHz
