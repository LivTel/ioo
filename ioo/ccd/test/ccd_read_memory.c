/* ccd_read_memory.c
 * $Header: /space/home/eng/cjm/cvs/ioo/ccd/test/ccd_read_memory.c,v 1.1 2011-11-23 11:03:02 cjm Exp $
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
 ...
 */
static char rcsid[] = "$Id: ccd_read_memory.c,v 1.1 2011-11-23 11:03:02 cjm Exp $";
/**
 ...
 * @see #Memory_Address
 * @see #Log_Level
 * @see ../cdocs/ccd_dsp.html#CCD_DSP_Command_RDM
...
int main(int argc, char *argv[])
{
	...
	fprintf(stdout,"Result (hexadecimal) = %#x\n",retval);
	fprintf(stdout,"Result (integer) = %d\n",retval);
